...
<div class="prose-zinc prose-lg dark:prose-invert mx-auto mb-10">
	...
	<p>
		...
		>. There are several different types of lists. All types of lists are replaceable, meaning that
		only the most recent event (version of your list) matters.
	</p>
	<ul class="list-disc list-inside">
		...
		<li>
			<strong>Categorized People list:</strong> <code>(kind: 30000)</code> This is a list of users with
			a title. Hence, you can store any type of people list you'd like.
		</li>
		<li>
			<strong>Categorized Bookmark list:</strong> <code>(kind: 30001)</code> This is a list of notes
			with a title. Hence, you can store any arbitrary list of notes you'd like.
		</li>
	</ul>
	<p>
